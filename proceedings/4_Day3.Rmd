...
Wickam (senior scientist at RStudio) to get participants started with developing
...
Ann Mariscak (from the Pacific Region CSAS office) spoke regarding
the new policies for generating CSAS documents.  As a
legal requirement, the Department must ensure that all CSAS documents are
available in both official languages.  Also, it is required that the
...
This motivated participants' development of the fishrosetta package (see below),
such that authors should somewhat easily be able to create figures in both 
languages.
Mariscak also noted that manual editing (through Photoshop and other tools) often degrades quality of the figures.
...
less a less expensive service than translation, this could be an option worth
...
translation database native to DFO called the [DFO Bilingual
Lexicon](http://www.btb.termiumplus.gc.ca/).
...
summarizing one day of the workshop.  A proceedings template document that met
