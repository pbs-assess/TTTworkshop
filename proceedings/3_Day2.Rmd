...
R Markdown is compatible with latex, but is a much simpler to learn markup language.
...
Pacific region has written an R package called csasdown  (based on the R package bookdown) to help authors write research documents formatted for Canadian Science Advisory Secretariat.  
