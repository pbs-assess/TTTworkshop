...
R Markdown allows analysts to inter-space text, R code, and R output.
...
Pacific Region has written an R package called csasdown  (based on the R package bookdown) to help authors write research documents formatted for the Canadian Science Advisory Secretariat [(CSAS)](http://www.dfo-mpo.gc.ca/csas-sccs/index-eng.htm).
...
Rob provided a brief overview of the broad implications of Bill C-68 in the context of the DFO PA Framework [@DFO2013].
