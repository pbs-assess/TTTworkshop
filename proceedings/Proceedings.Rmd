...
\newcommand{\trTitle}{Proceedings of the Technical Expertise in Stock Assessment
 ...
 assessments,' 27\textendash{}30 November 2018 in Nanaimo, British Columbia}
\newcommand{\trYear}{YYYY}
\newcommand{\trReportNum}{3290}
\newcommand{\trISBNprint}{978-0-660-28901-4}
\newcommand{\trISBNpdf}{978-0-660-28902-1}
...
<!-- Abstract -->
\newcommand{\trAbstract}{
A four-day workshop was held in Nanaimo, British Columbia, from 27--30
...
R package to facilitate efficient translation of figures appearing in
