...
\emph{Traceable}: One should be able to link results to components;
...
A fourth T could be \emph{Translatable} in the sense that with two official languages, it is important to ensure proper document standards to enable consistent translations between official languages. Software demonstrations were given of Git, Github, RMarkdown, knitr and LaTeX, and group work was conducted around the use of these tools.
