...
labels) within figures of CSAS documents. It contains an expanding list of
translated technical terms (that a user can help update), and also allows for
translation into Inuktitut.
A third group commenced writing of this Proceedings document (using a template
